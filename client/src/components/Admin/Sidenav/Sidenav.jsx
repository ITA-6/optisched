...
const Sidenav = () => {
  ...
  return (
    <>
      <nav
        className={`${((!isHoverOn && isSidebarOpen) || isHoverOn )? "lg:hover:w-[16em]" : "w-20 xm:w-0 sm:w-0"} z-50 fixed top-0 h-screen font-noto bg-white pt-4 text-black shadow-outerShadow ${isSidebarOpen ? "w-[16em]": "lg:w-20"} ${isManagementOpen ? "xm:overflow-auto" : "overflow-hidden"} ease-linear duration-200 `}

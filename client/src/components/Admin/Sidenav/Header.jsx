...
const Header = ({ pageName }) => {
  ...
  return (
    <div className={`sm: xl: z-1 fixed top-0 flex w-screen items-center justify-between bg-green shadow-outerShadow font-noto`}>
      ...
      <div className="relative">
        <button onClick={toggleUser}>
          <img src={userIcon} className="m-2 mr-5 xm:h-10  md:inline" alt="User" />
        </button>
        <ul

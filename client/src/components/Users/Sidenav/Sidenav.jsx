...
const Sidenav = () => {
  ...
  return (
    <>
      <nav
        className={`z-3 block absolute top-0 min-h-screen  bg-white  pt-8 text-black shadow-outerShadow ease-out duration-300 ${isSidebarOpen ? "w-[16em] " : "xm:w-0 sm:w-0 lg:w-14"}`}
      >

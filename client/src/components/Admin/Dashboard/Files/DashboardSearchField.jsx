...
const DashboardSearchField = () => {
  return (
    <div className="grid grid-cols-[5fr_0.5fr_1fr] items-center grid-areas-text-user grid-in-text">
        <p className="mt-5 text-xl grid-in-userText xm:text-base">User Login History</p>
        <div className="grid-in-search mt-5 xm:hidden">
            <input
                type="text"
                name="search"
                id="search"
        ...
        <div className="ml-7 text-center grid-in-list mt-5 xm:hidden">
